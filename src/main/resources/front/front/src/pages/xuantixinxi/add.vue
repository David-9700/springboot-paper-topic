...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="选题编号" prop="xuantibianhao">
              <el-input v-model="ruleForm.xuantibianhao" placeholder="选题编号" disabled></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="人数" prop="renshu">
            <el-select v-model="ruleForm.renshu" placeholder="请选择人数" :disabled=" false  ||ro.renshu" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="选题时间" prop="xuantishijian">
              <el-date-picker
