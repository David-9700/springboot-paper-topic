...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="课题名称" prop="ketimingcheng">
            <el-input v-model="ruleForm.ketimingcheng" 
                placeholder="课题名称" clearable :disabled=" false  ||ro.ketimingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="课题分类" prop="ketifenlei">
            <el-select v-model="ruleForm.ketifenlei" placeholder="请选择课题分类" :disabled=" false  ||ro.ketifenlei" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="课题封面" v-if="type!='cross' || (type=='cross' && !ro.ketifengmian)" prop="ketifengmian">
            <file-upload
            tip="点击上传课题封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="课题封面" prop="ketifengmian">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="院系" prop="yuanxi">
            <el-select v-model="ruleForm.yuanxi" placeholder="请选择院系" :disabled=" false  ||ro.yuanxi" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="课题状态" prop="ketizhuangtai">
            <el-select v-model="ruleForm.ketizhuangtai" placeholder="请选择课题状态" :disabled=" false  ||ro.ketizhuangtai" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="可选人数" prop="renshu">
            <el-input v-model.number="ruleForm.renshu" 
                placeholder="可选人数" clearable :disabled=" false  ||ro.renshu"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="开题日期" prop="kaitiriqi">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="课题要求" prop="ketiyaoqiu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="课题要求"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="课题内容" prop="ketineirong">
            <editor 
