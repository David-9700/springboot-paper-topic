    ...
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="报告编号" prop="baogaobianhao">
            <el-input v-model="ruleForm.baogaobianhao" 
                placeholder="报告编号" clearable :disabled=" false  ||ro.baogaobianhao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="具体时间" prop="jutishijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="意见建议" prop="yijianjianyi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="意见建议"
