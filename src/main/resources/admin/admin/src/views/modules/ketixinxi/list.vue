	...
	<div class="main-content" :style='{"minHeight":"calc(100vh - 200px)","padding":"20px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
			...
			<el-form class="center-form-pv" :style='{"border":"0px solid #ceddee","minHeight":"100px","padding":"10px 0px","boxShadow":"0 0px 0px 0px rgba(100,100,100,.05)","margin":"0px","overflow":"hidden","borderRadius":"20px 20px","flexWrap":"wrap","background":"none","display":"flex","fontSize":"inherit","justifyContent":"center"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","boxShadow":"0 0px 0px 0px rgba(115,108,203,.23)","margin":"0 0px 0px 0","borderRadius":"0px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"auto","fontSize":"inherit","justifyContent":"flex-end","order":"2"}' >
					<div :style='{"margin":"0 5px 10px 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 5px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">课题名称</label>
						<el-input v-model="searchForm.ketimingcheng" placeholder="课题名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 5px 10px 0","fontSize":"inherit","display":"inline-block"}' class="select" label="院系" prop="yuanxi">
						<label :style='{"margin":"0 5px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">院系</label>
					...
					<div :style='{"margin":"0 5px 10px 0","fontSize":"inherit","display":"inline-block"}' class="select" label="专业" prop="zhuanye">
						<label :style='{"margin":"0 5px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">专业</label>
					...
					<div :style='{"margin":"0 5px 10px 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 5px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">教师姓名</label>
				...
				<el-row class="actions" :style='{"boxShadow":"0 0px 0px 0px rgba(115,108,203,.23)","padding":"0 20px 0 0","margin":"0px 0 0px","color":"#333","alignItems":"center","textAlign":"left","display":"flex","justifyContent":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","flex":"1","width":"auto","fontSize":"inherit","order":"1"}'>
					...
					<el-button class="btn18" v-if="isAuth('ketixinxi','导入')" type="success" @click="importHandler()">
						<span class="icon iconfont icon-xiazai6" :style='{"margin":"0 2px","color":"#327e33","left":"10px","display":"inline-block","fontSize":"24px","position":"absolute","fontWeight":"500"}'></span>
						导入
					</el-button>
					<el-button class="btn18" v-if="isAuth('ketixinxi','上传模板')" type="success" @click="importClcik">
						<span class="icon iconfont icon-shangchuan8" :style='{"margin":"0 2px","color":"#327e33","left":"10px","display":"inline-block","fontSize":"24px","position":"absolute","fontWeight":"500"}'></span>
						上传模板
					</el-button>
					<el-button class="btn18" v-if="isAuth('ketixinxi','下载模板')" type="success" @click="download('upload/ketixinxi_template.xlsx')">
						<span class="icon iconfont icon-xiazai5" :style='{"margin":"0 2px","color":"#327e33","left":"10px","display":"inline-block","fontSize":"24px","position":"absolute","fontWeight":"500"}'></span>
						下载模板
					</el-button>

					<download-excel v-if="isAuth('ketixinxi','导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "课题信息.xls">
						<!-- 导出excel -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="ketifengmian" width="200" label="课题封面">
						<template slot-scope="scope">
							<div v-if="scope.row.ketifengmian">
								<img v-if="scope.row.ketifengmian.substring(0,4)=='http'" :src="scope.row.ketifengmian.split(',')[0]" width="100" height="100" style="object-fit: cover">
								<img v-else :src="$base.url+scope.row.ketifengmian.split(',')[0]" width="100" height="100" style="object-fit: cover">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('ketixinxi','选题')" @click="xuantixinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','','')" type="success">
        ...
        <el-dialog title="上传模板" :visible.sync="importVis" width="50%">
            <el-form ref="form" :model="importForm" label-width="80px">
                <el-form-item class="upload" label="文件" prop="excelFile">
                    <el-upload class="upload-demo" drag :action="$base.url + 'file/upload?type=ketixinxi_template'"
...
//导出excel
				json_fields: {
					"课题名称": "ketimingcheng",    //常规字段
					"课题分类": "ketifenlei",    //常规字段
					"课题封面": "ketifengmian",    //常规字段
					"院系": "yuanxi",    //常规字段
					"专业": "zhuanye",    //常规字段
					"课题状态": "ketizhuangtai",    //常规字段
					"可选人数": "renshu",    //常规字段
					"课题要求": "ketiyaoqiu",    //常规字段
					"课题内容": "ketineirong",    //常规字段
					"开题日期": "kaitiriqi",    //常规字段
		...
		methods: {
			...
			xuantixinxiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
