...
<div class="content" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230830/d58ecc944fb54dbfa18ecd2b64e92170.png) no-repeat center top / cover","display":"flex","width":"100%","fontSize":"16px","justifyContent":"center","height":"100%"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"padding":"10px 20px","margin":"0px auto 40px","borderColor":"#ceddee","color":"rgb(51, 51, 51)","borderRadius":"0px","textAlign":"center","background":"none","borderWidth":"0px","width":"100%","fontSize":"28px","borderStyle":"solid","fontWeight":"500"}'>你好欢迎使用 {{this.$project.projectName}}</div>
...
import TeacherAiTools from '@/components/TeacherAiTools.vue'
